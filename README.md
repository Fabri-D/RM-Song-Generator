...
## AI Song Contest (External Evaluation)

Reharmonization Maps has been used as a compositional engine in external artistic contexts.

In 2025, the piece *“Emersio Taciti”* — generated by the RM Song Generator
(Team: black_steel) — was selected as a Semifinalist (Top 29 worldwide)
in the AI Song Contest 2025.

The work is an assembly of sections composed by a symbolic, non-neural
algorithmic system based on harmonic logic and millions of precomputed
scale–chord relationships, with no (or near-zero) human musical intervention.

This selection among international teams from universities, research labs,
and independent artists serves as external validation of a structural,
rule-based approach to computational music generation.

Links:
- AI Song Contest 2025 — Team black_steel (official participant page):
